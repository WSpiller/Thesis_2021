...
print(xtable(summary(BMI1)),type="html")
...
print(xtable(summary(VA1)),type="html")
...
png("CS_Forest1.png",width=5.33,height=4,units="in",res=500)
uniplot6
dev.off()
